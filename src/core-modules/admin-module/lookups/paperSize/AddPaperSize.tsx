...
const AddPaperSize: React.FC<AddFeeInstallmentTypeProps> = ({ onClose, onReload }) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response: any = await createPaperSize(feeTypeData);
            if (response.success) {
    ...
    return (
        <div className="bg-white rounded-xl  p-6 w-full max-w-md">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-semibold text-gray-800">Add Paper Size</h2>
                <button
                    onClick={onClose}

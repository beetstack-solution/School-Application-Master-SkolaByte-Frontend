...
import { createPaperSize } from '@/api/admin-api/lookups-api/paperSizeApi';
import { createTemplateType } from '@/api/admin-api/lookups-api/templateTypeApi';
...
const AddTemplateType: React.FC<AddFeeInstallmentTypeProps> = ({ onClose, onReload }) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response: any = await createTemplateType(feeTypeData);
            if (response.success) {
    ...
    return (
        <div className="bg-white rounded-xl  p-6 w-full max-w-md">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-semibold text-gray-800">Add Template Type</h2>
                <button
                    onClick={onClose}
